# NCAA 2025 Men's Basketball Tournament Prediction
...
## Project Workflow
1. **Data Collection & Cleaning:** Loaded NCAA datasets, checked consistency, and merged historical records.
2. **Feature Engineering:** Computed advanced basketball metrics and handled outliers.
3. **Matchup Generation:** Created all possible 2025 tournament matchups using team combinations.
4. **Model Training:** Trained XGBoost and Random Forest classifiers; evaluated using Brier Score, AUC, and accuracy.
5. **Model Interpretation:** Used SHAP to analyze feature impact on prediction results.
6. **Prediction Generation:** Predicted win probabilities for all matchups and formatted results for submission.
